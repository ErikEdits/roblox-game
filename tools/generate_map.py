...
plaza = [
    ...
    kiosk("DeliveryKiosk", 40, -52, "DELIVERY JOBS", ORANGE, "Delivery"),
...
ent = [
    ...
    model("ReflexMachine", [
        part("Cabinet", (222, 4, -42), (7, 8, 3.5), rgb(10, 40, 20), attrs={"Prompt": "Reflex"}),
        part("Screen", (222, 5, -40.2), (5.6, 3.6, 0.2), LIME, "Neon"),
        part("Marquee", (222, 8.8, -42), (7.4, 1.8, 3.9), rgb(5, 25, 10),
             children=[label("NEON REFLEX", "Back", LIME)]),
    ]),
